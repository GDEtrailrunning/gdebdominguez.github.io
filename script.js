...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [15, 24, 21, 20, 30],// Datos de los km recorridos en cada día
...
const dataLine2 = {
  labels: ['Día 1', 'Día 2', 'Día 3', 'Dí0a 4', 'Día 5'], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 32',
    data: [10, 19, 23, 14, 34], // Datos de los km recorridos en cada día
